...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        strategy.setSuperEntityClass("com.crescentd.entity.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
        strategy.setSuperControllerClass("com.crescentd.controller.BaseController");
        // 写于父类中的公共字段
